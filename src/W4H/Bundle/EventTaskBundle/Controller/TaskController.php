...
class TaskController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('W4HEventTaskBundle:Task')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('W4HEventTaskBundle:Task')->find($id);
     ...
     * @Method("post")
     * @Template("W4HEventTaskBundle:Task:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("W4HEventTaskBundle:Task:edit.html.twig")
     */
